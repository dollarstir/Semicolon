                    ...
                    <div class="product-title-area">
                        ...
                        <div class="filter__menu">
                            ...
                            <div class="filter__menu_icon">
                                <a href="index.php#" id="drop1" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <img class="svg" src="images/svg/menu.svg" alt="menu icon">
                                </a>

                                <ul class="filter_dropdown dropdown-menu" aria-labelledby="drop1">
                                    <li>
                                        <a href="index.php#">Trending items</a>
                                    </li>
                                    <li>
                                        <a href="index.php#">Best seller</a>
                                    </li>
                                    <li>
                                        <a href="index.php#">Best rating</a>
                                    </li>
                                    <li>
                                        <a href="index.php#">Low price</a>
                                    </li>
                                    <li>
                                        <a href="index.php#">High price</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="sorting">
                        <ul>
                            <li>
                                <a href="index.php#">Plugins</a>
                            </li>
                            <li>
                                <a href="index.php#">WordPress</a>
                            </li>
                            <li>
                                <a href="index.php#">Site Template</a>
                            </li>
                            <li>
                                <a href="index.php#">PSD Template</a>
                            </li>
                            <li>
                                <a href="index.php#">Joomla</a>
                            </li>
                            <li>
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="product product--card">
                        ...
                        <div class="product-desc">
                            ...
                            <ul class="titlebtm">
                                <li>
                                    <img class="auth-img" src="images/auth2.jpg.png" alt="author image">
                                    <p>
                                        <a href="index.php#">AazzTech</a>
                                    </p>
                                </li>
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="product product--card">
                        ...
                        <div class="product-desc">
                            ...
                            <ul class="titlebtm">
                                <li>
                                    <img class="auth-img" src="images/auth3.jpg.png" alt="author image">
                                    <p>
                                        <a href="index.php#">AazzTech</a>
                                    </p>
                                </li>
                ...
                <div class="col-md-12">
                    <div class="product_slider">
                        ...
                        <div class="product product--card">
                            ...
                            <div class="product-desc">
                                <a href="index.php#" class="product_title">
                                    <h4>Ajax Live Search</h4>
                                </a>
                                <ul class="titlebtm">
                                    <li>
                ...
                <div class="col-md-6 no-padding">
                    <div class="proposal proposal--left bgimage">
                        ...
                        <div class="content_above">
                            ...
                            <a href="index.php#" class="btn--round btn btn--lg btn--white">Become an Author</a>
                        </div>
                    </div>
                    <!-- end /.proposal -->
                </div>
                ...
                <div class="col-md-6 no-padding">
                    <div class="proposal proposal--right">
                        ...
                        <div class="content_above">
                            ...
                            <a href="index.php#" class="btn--round btn btn--lg btn--white">Start Shopping</a>
                        </div>
                    </div>
                    <!-- end /.proposal -->
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="news">
                        ...
                        <div class="news__content">
                            <a href="index.php#" class="news-title">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="call-to-wrap">
                        ...
                        <a href="index.php#" class="btn btn--lg btn--round btn--white callto-action-btn">Join Us Today</a>
                    </div>
                </div>
            </div>
        </div>
