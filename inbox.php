        ...
        if ($cco >=1) {
            ...
            <div class="attachment">
                ...
                while ($rat =mysqli_fetch_array($sel)) {
                    ...
                    echo'<li>
                    <a href="attachment/'.$rat['doc'].'" title="'.$rat['doc'].'" target="blank" class="venobox">';
                    if(preg_match("/\.png$/",$rat['doc']) || preg_match("/\.jpeg$/",$rat['doc'])|| preg_match("/\.gif$/",$rat['doc']) || preg_match("/\.jpg$/",$rat['doc'])){
                        echo ' <img src="attachment/'.$rat['doc'].'" alt="image attachment" style="width:50px;height:50px;">    ';
                    
                    }
                    elseif (preg_match("/\.mp4$/",$rat['doc']) || preg_match("/\.3gp$/",$rat['doc'])) {
                        echo ' <img src="images/video.png" alt="image attachment" style="width:50px;height:50px;">';
                        # code...
                    }

                    elseif (preg_match("/\.mp3$/",$rat['doc']) || preg_match("/\.mu3$/",$rat['doc'])) {
                        echo ' <img src="images/aud2.png" alt="image attachment" style="width:50px;height:50px;">';
                        # code...
                    }
                    elseif (preg_match("/\.zip$/",$rat['doc']) || preg_match("/\.rar$/",$rat['doc'])) {
                        echo ' <img src="images/zip.png" alt="image attachment" style="width:50px;height:50px;">';
                        # code...
                    }

                    elseif (preg_match("/\.pdf$/",$rat['doc'])) {
                        echo ' <img src="images/pdf.png" alt="image attachment" style="width:50px;height:50px;">';
                        # code...
                    }

                    elseif (preg_match("/\.html$/",$rat['doc'])) {
                        echo ' <img src="images/html.png" alt="image attachment" style="width:50px;height:50px;">';
                        # code...
                    }

                    elseif (preg_match("/\.js$/",$rat['doc'])) {
                        echo ' <img src="images/js.png" alt="image attachment" style="width:50px;height:50px;">';
                        # code...
                    }

                    elseif (preg_match("/\.php$/",$rat['doc'])) {
                        echo ' <img src="images/php.png" alt="image attachment" style="width:50px;height:50px;">';
                        # code...
                    }

                    elseif (preg_match("/\.css$/",$rat['doc'])) {
                        echo ' <img src="images/css.png" alt="image attachment" style="width:50px;height:50px;">';
                        # code...
                    }

                    elseif (preg_match("/\.sql$/",$rat['doc'])) {
                        echo ' <img src="images/sql.png" alt="image attachment" style="width:50px;height:50px;">';
                        # code...
                    }

                    elseif (preg_match("/\.webp$/",$rat['doc'])) {
                        echo ' <img src="attachment/'.$rat['doc'].'" alt="image attachment" style="width:50px;height:50px;">';
                        # code...
                    }
                    echo '</a>
