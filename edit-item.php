...
<body class="preload dashboard-upload">
    <?php
        ...
        $getprod = mysqli_query($conn,"SELECT * FROM products WHERE  id='$prodid'");
        $rp= mysqli_fetch_array($getprod);
        extract($rp);
    ?>
                            ...
                            <div class="upload_modules">
                                ...
                                <div class="modules__content">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="product_name" class="text_field" placeholder="Enter your product name here..." name="item" value="<?php echo $item ;?>">
                                        <input type="hidden" id="" class="text_field" placeholder="Enter your product name here..." name="pic1" value="<?php echo $thumbnail ;?>">
                                        <input type="hidden" id="" class="text_field" placeholder="Enter your product name here..." name="pic2" value="<?php echo $mainfile ;?>">
                                        <input type="hidden" id="" class="text_field" placeholder="Enter your product name here..." name="pic3" value="<?php echo $screenshot    ;?>">
                                        <input type="hidden" id="" class="text_field" placeholder="Enter your product name here..." name="id" value="<?php echo $prodid    ;?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="" class="text_field" placeholder="Enter demo link " name="demo" value="<?php echo $demo ;?>">
                                    </div>
                                ...
                                <div class="modules__content">
                                        ...
                                        <div class="upload_wrapper">
                                            ...
                                            <div class="progress_wrapper">
                                                <div class="labels clearfix">
                                                    <img src="thumbnails/<?php echo $thumbnail ;?>" alt="" id="tmbpic">
                                    ...
                                    <div class="form-group">
                                        <div class="upload_wrapper">
                                            ...
                                            <div class="progress_wrapper">
                                                <div class="labels clearfix">
                                                    <p id="fn"> <strong>Name:</strong> <?php echo $mainfile ;?> </p>
                                                    <!-- <p id="ft"></p>
                                    ...
                                    <div class="form-group">
                                        <div class="upload_wrapper">
                                            ...
                                            <div class="progress_wrapper">
                                                <div class="labels clearfix">
                                                    <img src="screenshots/<?php echo $screenshot ;?>" alt="" id="screenpic">
                            ...
                            <div class="upload_modules">
                                ...
                                <div class="modules__content">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea name="language" placeholder="separate them with comma's eg : Php,html ..."><?php echo $language ;?></textarea>
                                            </div>
                                            <!-- end /.form-group -->
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea name="browsers" placeholder="separate them with comma's eg: Firefox,IE ..."><?php echo $browsers ;?></textarea>
                                            </div>
                                            <!-- end /.form-group -->
                                        </div>
                                        <!-- end /.col-md-6 -->
                                    ...
                                    <div class="form-group">
                                           ...
                                           <input type="text" id="" class="text_field" placeholder="Enter version " name="version" value="<?php echo $version ;?>">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="tags" id="tags" class="text_field" placeholder="Enter your item tags here..."><?php echo $tags;?></textarea>
                                    </div>
                                </div>
                                <!-- end /.upload_modules -->
                            </div>
                            ...
                            <div class="upload_modules with--addons">
                                ...
                                <div class="modules__content">
                                    <div class="row">
                                        ...
                                        <span class="input-group-addon">$</span>
                                        <input type="number" id="" class="text_field" placeholder="Enter your price" name="price" value="<?php echo $price;?>">
